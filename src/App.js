  ...
  render() {
    ...
    return (
      <div onMouseDown={this.handleClickDown}>
        ...
        <button onClick={this.handleClick}>{action ? 'click the screen to freeze' : 'let’s dance' }</button>
        </header>
        ...
        <div onMouseMove={action ? this.handleMouseMove : undefined} onTouchMove={ action ? this.handleMouseMove : undefined} className="mouse-area-wrapper">
